...
void pushMergedNeuronUpdateGroup0ToDevice(unsigned int idx, unsigned int* spkCnt, unsigned int* spk, scalar* V, scalar* RefracTime, float* inSynInSyn0, float* inSynInSyn1, uint32_t* recordSpk, unsigned int numNeurons) {
    MergedNeuronUpdateGroup0 group = {spkCnt, spk, V, RefracTime, inSynInSyn0, inSynInSyn1, recordSpk, numNeurons, };
...
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID0[] = {0, 3200, };
