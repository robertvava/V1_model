...
EXPORT_VAR scalar* d_RefracTimeE;
...
EXPORT_VAR scalar* d_RefracTimeI;
...
EXPORT_FUNC void pushRefracTimeEToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullRefracTimeEFromDevice();
EXPORT_FUNC void pushCurrentRefracTimeEToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullCurrentRefracTimeEFromDevice();
EXPORT_FUNC scalar* getCurrentRefracTimeE(unsigned int batch = 0); 
...
EXPORT_FUNC void pushRefracTimeIToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullRefracTimeIFromDevice();
EXPORT_FUNC void pushCurrentRefracTimeIToDevice(bool uninitialisedOnly = false);
EXPORT_FUNC void pullCurrentRefracTimeIFromDevice();
EXPORT_FUNC scalar* getCurrentRefracTimeI(unsigned int batch = 0); 
